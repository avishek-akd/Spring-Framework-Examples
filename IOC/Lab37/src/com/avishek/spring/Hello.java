...
public class Hello implements InitializingBean, BeanNameAware, BeanFactoryAware, ApplicationContextAware, DisposableBean {
	...
	public void show()
	{
		...
		System.out.println("Hello Bean Running In ApplicationFactory:-"+ctx1);
		
		System.out.println("Hello Bean Running In BeanFactory:-"+factory2);
		System.out.println("Hello Bean Running In ApplicationFactory:-"+ctx2);
	}
